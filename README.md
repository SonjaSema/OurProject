...
- Të aplikoj konceptet e versionimit të kodit me **Git** dhe **GitHub**.
- Të publikoj projektin ekzistues në një repository publik.
...
- `manage.py` – skedari kryesor për komandat e Django.
- `app/` – aplikacioni kryesor i projektit.
- `templates/` – skedarët HTML.
- `static/` – skedarët CSS/JS.
